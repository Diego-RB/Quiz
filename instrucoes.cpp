...
void instrucoes(){
    system("cls");                                                              
    printf ("\n\n\t5 - INSTRUCOES\n\n");   
    printf ("\tEste é um divertido jogo de perguntas e respostas.\n\tO jogador deverá escolher,");
	printf (" dentre as 4 alternativas (A, B, C, D),\n\tapenas uma e em seguida pressionar \"enter\".\n\n");
	printf ("\tAo escolher a opção E, será dado uma dica. O usuario só poderá usar 2 vezes durante  o jogo.\n\n");
	printf ("\tO jogo lhe informa se vc acertou ou errou a questao.\n\n");
	printf ("\tO jogo possui 3 niveis de dificuldade:\n\n");
	printf ("\tTodos Niveis - Neste modo vc jogará o game completo.\n");
